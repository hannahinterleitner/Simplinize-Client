...
@Component({
  selector: 'app-check-anwesend',
  templateUrl: './check-anwesend.component.html',
  styleUrls: ['./check-anwesend.component.scss'],
})
export class CheckAnwesendComponent implements OnInit {
